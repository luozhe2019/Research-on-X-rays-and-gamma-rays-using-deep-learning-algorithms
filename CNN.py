...
conv1 = keras.layers.Conv1D(filters= 32, kernel_size=8, padding='same')(input_fca)
...
conv4 = keras.layers.Activation(activation='selu')(conv4)

conv5 = keras.layers.Conv1D(filters=32, kernel_size=3, padding='same')(conv4)
conv5 = keras.layers.BatchNormalization()(conv5)
conv5 = keras.layers.Activation(activation='selu')(conv5)

gap_layer = keras.layers.GlobalAveragePooling1D()(conv5)


output__layer = keras.layers.Dense(1, activation='sigmoid')(gap_layer)
