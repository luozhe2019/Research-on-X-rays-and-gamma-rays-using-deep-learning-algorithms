...
l1 = tf.keras.layers.SimpleRNN(units = 32,dropout= 0.5,return_sequences=True)(input_fca)
print(l1)

l2 = keras.layers.Bidirectional(keras.layers.SimpleRNN(units=64,dropout = 0.7,return_sequences=False))(l1)




l4 = tf.keras.layers.Dense(64,activation= 'selu')(l2)

l5 = tf.keras.layers.Dense(32,activation= 'selu')(l4)

output__layer = tf.keras.layers.Dense(1,activation= 'sigmoid')(l5)
