...
l1 = tf.keras.layers.GRU(units = 32,dropout= 0.5,return_sequences=True)(input_fca)
print(l1)

l2 = keras.layers.Bidirectional(keras.layers.GRU(units=64,dropout = 0.7,return_sequences=False))(l1)
